...
Route::get('/restaurants', function () {
    return response()->json([
        [
            ...
            "image_url" => "https://www.rico.guide/wp-content/uploads/2024/05/00-principal-Al-Andalus-ft.png",
            "name" => "Al Andalus",
            "short_description" => "Comida libanesa tradicional",
            "short_description_eng" => "Comida libanesa tradicional eng",
            "description" => "Comida libanesa tradicional des",
            "description_eng" => "Comida libanesa tradicional des eng",
            "address" => "Calle de Mesones 171, Centro Histórico de la Cdad. de México, Centro, Cuauhtémoc, Ciudad de México",
            "area" => "Roma",
            "quote_text" => "Sencillo, acogedor y familiar, donde el irresistible olor de la barbacoa te atrapa.",
            "quote_text_eng" => "Sencillo, acogedor y familiar, donde el irresistible olor de la barbacoa te atrapa. eng",
