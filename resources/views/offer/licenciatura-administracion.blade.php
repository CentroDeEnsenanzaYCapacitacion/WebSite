...
@section('title', 'Licenciatura en Administración - CEC')

@section('content')
<div class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            <h1 class="display-4 fw-bold text-primary">Licenciatura en Administración</h1>
        ...
        <div class="row g-4">
            ...
            <div class="col-12 text-center mt-4">
                <a href="{{ asset('assets/pdf/licenciatura-administracion.pdf') }}" class="btn btn-outline-primary btn-lg rounded-pill px-5 me-3" target="_blank">
