...
@section('title', 'Cursos Especiales Kids - CEC')

@section('content')
<div class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            <h1 class="display-4 fw-bold text-primary">Cursos Especiales Kids</h1>
            <div class="bg-primary mx-auto mb-3 title-underline"></div>
            <p class="lead text-muted">Educación temprana de calidad</p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-12 text-center mt-4">
                <a href="{{ asset('assets/pdf/cursos-kids.pdf') }}" class="btn btn-outline-primary btn-lg rounded-pill px-5 me-3" target="_blank">
